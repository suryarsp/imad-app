...
var rad=0;
 ...
 //to display cooments in each pages
 
 var submit=document.getElementById('submit_comments');
    submit.onclick=function(){
      //Make request to server and send the names
     ...
     request.onreadystatechange=function(){
         ...
         if(request.readyState===XMLHttpRequest.DONE)
         {
          ...
          //Make the request
          request.open('GET','http://rspsuriya777.imad.hasura-app.io/:pageNumber',true);
          request.send(null);
